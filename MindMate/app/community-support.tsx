// MindMate/app/community-support.tsx
...
export default function CommunitySupportScreen() {
  ...
  const fetchSupportRequests = async () => {
    try {
      setIsLoading(true);
      const requests = await mentalHealthApi.getCommunitySupportRequests();
      ...
      <View style={styles.requestCard}>
        ...
        <View style={styles.requestActions}>
          <Text style={styles.requestText}>
            A community member might need support based on their health data
          </Text>
          <Pressable
          ...
          >
            ...
            <Text style={styles.supportButtonText}>Provide Community Support</Text>
          </Pressable>
        </View>
      </View>
    );
  ...
  return (
    <>
      <Stack.Screen options={{
        title: 'Community Support Requests',
        headerShown: true
      }} />
      <View style={styles.container}>
        {isLoading ? (
          ...
          <View style={styles.emptyContainer}>
            <FontAwesome name="users" size={64} color="#CCCCCC" />
            <Text style={styles.emptyText}>No community support requests at this time</Text>
...
const styles = StyleSheet.create({
  ...
  supportButton: {
    backgroundColor: '#4CAF50', // Different color for community support
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
    paddingVertical: 10,
