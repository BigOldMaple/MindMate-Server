...
const startServer = async () => {
    try {
        ...
        server.listen(port, '0.0.0.0', async () => {
            ...
            console.log(`  - Network: http://139.222.246.232:${port}`);
            console.log(`  - WebSocket: ws://139.222.246.232:${port}/ws`);
            console.log('\nMongoDB Status:');
            ...
            console.log(`  - Health Check: http://139.222.246.232:${port}/health`);
            console.log('---------------------------\n');
